...
-- 用途：
-- 1. 保存系统账号信息
-- 2. 区分角色（系统管理员 / 督导组 / 站点账号 / 质安部账号 / 发展计划部账号 / 油气事业部账号 / 非油事业部账号 / 财务部账号 / 片区账号）
...
-- - finance：财务部账号，station_id 可为空，默认按检查表范围查看相关数据
...
CREATE TABLE users (
    ...
    role TEXT NOT NULL,                                 -- 用户角色：root / supervisor / station_manager / quality_safety / development_plan / oil_gas / non_oil / finance / area_account
