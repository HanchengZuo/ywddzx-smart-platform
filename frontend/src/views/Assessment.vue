        ...
        <div class="card-surface section-card">
          ...
          <div class="analysis-block">
            ...
            <div class="analysis-text">
              你本期整体表现稳定，工作责任心和执行可靠性得到了较多正向反馈。AI
              根据他人提交的匿名短语评价和各维度评分进行汇总分析后认为：多数评价都指向“认真负责、执行较稳、配合度较高”这几个关键词，说明你在可靠性和任务落实方面具备较强优势。从群体对比来看，你在“工作态度”“执行落实”方面优于平均水平，但在“主动沟通”和“反馈及时性”方面仍有进一步提升空间。
            </div>
          </div>
