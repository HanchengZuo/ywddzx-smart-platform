<template>
  <div class="page-shell">
    ...
    <div class="card-surface content-card">
      <div v-if="hasPermission" class="placeholder-block">
        <div class="placeholder-title">培训系统内容建设中</div>
        <div class="placeholder-desc">当前页面预留为培训模块入口，后续可继续接入培训任务、学习记录、签到答题、培训统计等功能。</div>
      </div>
